...
/**
 * Implementation of the Portfolio interface. The Events have to be registered
...
public final class PortfolioEntity extends EventSourced implements Portfolio {
	...
	public Completes<PortfolioState> stockAcquired(String symbol, long acquisitionMarketTime, int amount,
		...
		return apply(new StockAcquired(state.id, symbol, acquisitionMarketTime, amount, acquisitionMarketPrice),
				() -> state);
	}
