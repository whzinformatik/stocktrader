...
public class AccountResource extends ResourceHandler {
	...
	private final String portfolioUrl = System.getenv("PORTFOLIO_URL"); // TODO http://localhost:18082 <-- readme
	...
	/**
	 * Returns an Account object which can be used to trigger initial methods to
	 * create Events.
	 * 
