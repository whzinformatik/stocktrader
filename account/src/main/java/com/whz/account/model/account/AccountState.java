...
/**
 * AccountState managing the Account object. It is responsible for creating and
 * changing an Account object.
 *
 * @author Lation
 */
public final class AccountState {
	...
	/**
	 * Method which will be called when an Account gets created via a given initial
	 * balance.
	 *
	 * @param balance - the initial balance
	 * @return AccountState - temporary AccountState object containing all necessary
	 *         information
	 */
	...
	/**
	 * Method which will be called when an Account invests money via a Portfolio by
	 * buying a stock.
	 *
	...
	/**
	 * Method which will be called when an Account receives a sentiment via a
	 * CommentTone by giving an assessment.
	 *
	 ...
	 * @param balance - current balance of the account which will be set when
	 *                creating an account
	 * @param amount  - current amount of invested money which will be later added
	 *                to the account
	 */
