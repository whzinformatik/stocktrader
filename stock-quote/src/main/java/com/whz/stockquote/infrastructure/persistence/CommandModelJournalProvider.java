...
public class CommandModelJournalProvider  {
  ...
  public static CommandModelJournalProvider using(final Stage stage, final SourcedTypeRegistry registry, final Dispatcher dispatcher) {
    ...
    entryAdapterProvider.registerAdapter(StockQuotePlaceholderDefined.class, new StockQuotePlaceholderDefinedAdapter());
    ...
    registry.register(new Info(journal, StockQuotePlaceholderDefined.class, StockQuotePlaceholderDefined.class.getSimpleName()));
